...
public class ControllerA {
	...
	public static void main(String[] args) {
		...
		// return type이 void 이므로 단독으로만 호출하여 명령을 실행 할 수 있다
		prime();
		
		// prime() method는 return type이 void이기 때문에 다른 명령문에 포함되거나 변수의 값을 생성할 수 없다
...
//		if(prime()) {	}
	...
	/*
	 * 매개변수도 없고, return type이 void(없다라고 표현)인 prime() method 선언
	 */
