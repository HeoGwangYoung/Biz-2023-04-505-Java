...
public class PublicConfig {
	...
	/*
	 * 클래스 method
	 * 프로젝트가 시작될때 자동으로 메모리에 loading 되어 사용할 준비가 완료되는 method
	 ...
	 * 원래는 이러한 변수, method를 정적변수, 정적 메서드 라고 한다
	 * 
	 * 프로젝트가 시작될때 언제든지 사용할 수 있도록 미리 준비되는 도구들
	 * 사용할때는 클래스명.변수, 클래스명.메서드() 와 같이 직접 클래스 이름을 통하여 접근한다
	 */
}
