...
public class ScoreDto {
	 ...
	 * 
	 * 1. 클래스 변수를 접근제한자 private 으로 선언
	 * 2. 변수 값을 읽고 쓰기 위한 setter, getter method 선언
	 * 3. 변수 값을 확인하기 위한 toString() method를 재 정의
	 */
	...
	/*
	 * java의 모든 클래스는 기본적으로 toString() method를 포함하고있다
	 * 하지만 기본 toString() 은 메모리 주소를 보여주는 코드가 포함
	 * 
	 * Dto 클래스에서는 변수의 값들을 문자열로 변환하여 return 하는 method로 재정의(다시 선언)한다
	 * 
	 * @Override : Annotation 키워드
	 * @Override : 기존에 존재하는 method를 다시 선언하겠다 라는 지시어
	 */
