...
/*
 * 일반적인 변수(primitive)는 method의 매개변수로 전달할때 변수 자체가 전달되는 것이 아니고 변수의 "값(데이터)"만 전달된다
 * 매개변수로 전달받은 method 에서 아무리 변수의 값을 변경해도 실제 값은 변경되지 않는다
 */
