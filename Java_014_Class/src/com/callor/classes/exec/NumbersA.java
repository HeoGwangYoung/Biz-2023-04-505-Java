...
public class NumbersA {
	...
	public static void main(String[] args) {
		...
		// 기본자료형 변수에 특별한 기능을 부가하여 여러용도로 사용하기 위한 키워드
		// 기본변수와 성질이 유사한 클래스들
		// Wrapper class
		...
		// int형 정수와 Integer형 정수는 기본 정수값을 저장하는 변수의 성질을 갖는다
		num1 = intNum1; // Integer type의 데이터를 int type의 변수에 저장
		intNum1 = num1; // int type의 데이터를 Integer type의 변수에 저장
		
		/*
		 *  primitive(기본형) 변수에 저장된 데이터를 wrapper(참조형) 변수에 저장하는 순간
		 *  확장된 기능을 사용할 수 있다
		 *  기본형 변수에 저장된 데이터를 참조형 변수에 저장하는 것
		 *  box에 기본형 변수를 담는 것과 유사해서 boxing 이라고 한다
		 *  
		 *  Wrapper 클래스에 저장된 데이터를 기본형 변수에 저장하는 것을 unboxing (박스 해체) 이라고 한다
		 */
	}
}
