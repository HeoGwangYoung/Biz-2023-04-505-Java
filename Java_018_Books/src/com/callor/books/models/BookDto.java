 ...
 * 페이지, 가격 항목은 정수형으로 나머지 항목은 문자열형으로
 * 
 ...
 * 		요즘의 JAVA에서는 데이터 클래스의 각 속성(요소, Field)의
 * 		접근 제한자를 public 으로 선언한다
 * 
 * 		Web Application Service 프로젝트를 구현할때
 * 		특히 SpringMVC 도구를 사용하여 구현할때는
 * 		접근제한자를 private으로 선언하고 각 속성의 접근을 하기위해 getter, setter method를 선언하는 패턴을 사용한다
 */
...
public class BookDto {
	 ...
	 * 그러는 과정에서 수정을 빼먹는 상황이 발생할 수 있다
	 * 
	 * 코드를 reFactoring 하는 과정에서 많은 문제를 발생 시킬수 있다
	 * reFactoring을 할때 가장 좋은 것은 최소한의 코드 수정이다
	 */
