...
public class ScoreExecV1 {
	...
	public static void main(String[] args) {
		...
		// ScoreService에 있는 method 들을 사용하기 위한 준비
		ScoreServiceV1 scService = new ScoreServiceV1();
		
		// ScoreService 클래스의 scoreList 객체 배열변수에 생성된(선언과 초기화가 완료된) scoreList 객체 배열값을
		// 세팅하는 절차
		...
		/*
		 * ScoreSerive의 scoreList 객체 배열을 public으로 하지않고 private 으로 선언한다
		 * 코드 어디선가 개발자(작성자)가 예기치 않게 scoreList 데이터가 변경되는 것을 방지하는 목적이다
		 * 
		 */
