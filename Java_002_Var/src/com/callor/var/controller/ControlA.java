...
public class ControlA {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * if(boolean type 변수) { } 만약 "boolean type 변수" 값이 true이면 { } block 내부의 코드를 실행하라
		 */
		...
		// bEven2 값이 true가 아니면?
		if(!bEven2) {
			System.out.println(num2 + " 는 짝수가 아닙니다");
		}
		/*
		 * Control key word
		 * 어떤 조건에 따라 명령 코드 실행 순서를 변경하는 명령문
		 * if() 명령문은 ()의 조건이 true, false냐 에 따라 코드의 실행순서를 변경한다
		 * 
		 * if() 명령문에서
